...
export const authentication = {
  ...
  fields: [
    {
      ...
      required: true,
      helpText:
        "Found in your browsers address bar after logging in. [API Details](https://developers.whispir.com/2a21cad9e5da7-authentication)",
      choices: {
  ...
  connectionLabel: "{{bundle.inpudData.username}}",
};
