...
export const ScenariosApi = {
  ...
  create: {
    display: {
        label: 'Create a Scenarios',
        description: 'Test'
    },
    operation: {
        inputFields: generateInputFields(scenarioCreateInput),
        perform: async (z: ZObject, bundle: InputBundle<typeof scenarioCreateInput>) => {
            const {
                workspaceId,
                ...scenario
            } = transformInputData(bundle.inputData);

            const localVarPath = bundle.authData.host + '/workspaces/{workspaceId}/scenarios'
