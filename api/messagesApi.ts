...
export const MessagesApi = {
  ...
  create: {
    display: {
        label: 'Create a Messages',
        description: 'Test'
    },
    operation: {
        inputFields: generateInputFields(messageCreateInput),
        perform: async (z: ZObject, bundle: InputBundle<typeof messageCreateInput>) => {
            const {
                workspaceId,
                ...message
            } = transformInputData(bundle.inputData);

            const localVarPath = bundle.authData.host + '/workspaces/{workspaceId}/messages'
